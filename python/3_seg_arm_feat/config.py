...
parser = argparse.ArgumentParser("vise_3_arm_feat")
...
parser.add_argument('--max_dataset_size', type=int, default=12000, help='maximum dataset size')
parser.add_argument('--dataset_size', type=int, default=12000, help='dataset size')
...
parser.add_argument('--result_dir', default='../results/3_arm_feat_new', help='Result dir [default: log]')
parser.add_argument('--report_freq', type=int, default=10, help='report batch frequency')
parser.add_argument('--wnb_project', type=str, default="vise_cnn_3_arm_feat_new", help='W&B project name')
