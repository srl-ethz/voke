...
parser = argparse.ArgumentParser("vise_3_arm")
...
parser.add_argument('--max_dataset_size', type=int, default=12504, help='maximum dataset size')
parser.add_argument('--dataset_size', type=int, default=12504, help='dataset size')
...
parser.add_argument('--scheduler_type', type=str, default='cos', help='type of lr scheduler type')
...
parser.add_argument('--result_dir', default='../results/3_arm', help='Result dir [default: log]')
