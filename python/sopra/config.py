...
parser = argparse.ArgumentParser("vise_sopra")
...
parser.add_argument('--label_filename', type=str, default='labels.txt', help='label file name')
...
parser.add_argument('--num_classes', type=int, default=6, help='number of outputs')

parser.add_argument('--batch_size', type=int, default=128, help='batch size')
parser.add_argument('--max_dataset_size', type=int, default=19288, help='maximum dataset size')
parser.add_argument('--dataset_size', type=int, default=19288, help='dataset size')
parser.add_argument('--validation_set_size', type=float, default=0.3, help='validation dataset proportion')
parser.add_argument('--testing_set_size', type=float, default=0, help='testing dataset proportion')
parser.add_argument('--training_go_overs', type=int, default=1, help='training go overs')
parser.add_argument('--validation_go_overs', type=int, default=1, help='validation go overs')
...
parser.add_argument('--result_dir', default='../results/sopra', help='Result dir [default: log]')
parser.add_argument('--report_freq', type=int, default=10, help='report batch frequency')
parser.add_argument('--wnb_project', type=str, default="vise_cnn_sopra", help='W&B project name')
