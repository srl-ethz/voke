...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        # Create new batches
        trainingBatches = f.generateBatchesSoPrA(trainingSet, trainingSetIndices, args.batch_size, args.training_go_overs, label)
        validationBatches = f.generateBatchesSoPrA(validationSet, validationSetIndices, args.batch_size, args.validation_go_overs, label)
